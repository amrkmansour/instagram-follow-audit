  ...
  app.innerHTML = `
    ...
    <main id="top">
      ...
      <section class="instructions" aria-labelledby="instructions-title">
        <div class="section-heading"><span aria-hidden="true">01</span><div><h2 id="instructions-title">How it works</h2><p>Three simple steps to check your following.</p></div></div>
        <ol class="steps">
          ...
          <li><b aria-hidden="true">2</b><h3>Upload the file you receive</h3><p>Return here and upload the file Instagram provides. It stays on your device.</p></li>
          <li><b aria-hidden="true">3</b><h3>See who doesn’t follow you back</h3><p>Get a clear list of the accounts you follow that don’t follow you back.</p></li>
        </ol>
      </section>
